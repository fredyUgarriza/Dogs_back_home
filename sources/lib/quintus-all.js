...
//*================FUNCIÓN MODIFICADA===================================*//
    collide: function(obj) {
            ...
            if(col && col.magnitude > 0) {
              if(colObj.p.sensor) {
                ...
                if(obj.trigger) { 
                 ...
                 isJumping = obj.p.vy < 0;//Determina si el objeto que colisiona está saltando
      ...
      //Si el objeto que colisiona está saltando entonces se ignora la colisión 
      return normal.collided > 0 && !isJumping ? normal : false;
    },
